    	...
    	@foreach($getCategories as $category)
    		...
    		@if(!empty($category['subcategories']))
		    	@foreach($category['subcategories'] as $subcategory)
		    		<option value="{{ $subcategory['id'] }}" @if(isset($categorydata['parent_id']) && $categorydata['parent_id'] == $subcategory['id'] ) selected="" @endif >&nbsp;&raquo;&raquo;&nbsp;{{ $subcategory['category_name'] }}</option>
		    	@endforeach
		    @endif
    	@endforeach
    @endif
